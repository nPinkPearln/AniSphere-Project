    ...
    <div className="container">
      <div className="row">
        ...
        <div className="d-grid col-md-4 py-4">
          <button href="" type="button" className="btn btn-outline-primary">
          ...
          <br />
          <button href="" type="button" className="btn btn-outline-warning">
            <span className="material-symbols-rounded align-bottom">
              rocket_launch
            </span>
            Official Instagram
          ...
          <br />
          <button href="" type="button" className="btn btn-outline-info">
            <span className="material-symbols-rounded align-bottom">
              rocket_launch
            </span>
            Official Twitter
